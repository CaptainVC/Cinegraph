...
from scripts.private_speaker_review_final_review_host_contract import (  # noqa: E402
    REVIEW_FINAL_REVIEW_HELPER_PATH,
    REVIEW_FINAL_REVIEW_RECEIPTS_ROOT,
)
from scripts.private_speaker_review_final_review_host_contract import (  # noqa: E402
    SUDOERS_CONTENT as FINAL_REVIEW_SUDOERS_CONTENT,
)
from scripts.private_speaker_review_final_review_observation_host_contract import (  # noqa: E402
    REVIEW_FINAL_REVIEW_OBSERVATION_HELPER_PATH,
    REVIEW_FINAL_REVIEW_OBSERVATION_RECEIPTS_ROOT,
)
from scripts.private_speaker_review_final_review_observation_host_contract import (  # noqa: E402
    SUDOERS_CONTENT as FINAL_REVIEW_OBSERVATION_SUDOERS_CONTENT,
)
...
from scripts.private_speaker_review_fourth_adjudication_host_contract import (  # noqa: E402
    REVIEW_FOURTH_ADJUDICATION_HELPER_PATH,
    REVIEW_FOURTH_ADJUDICATION_RECEIPTS_ROOT,
)
from scripts.private_speaker_review_fourth_adjudication_host_contract import (  # noqa: E402
    SUDOERS_CONTENT as FOURTH_ADJUDICATION_SUDOERS_CONTENT,
)
from scripts.private_speaker_review_fourth_adjudication_observation_host_contract import (  # noqa: E402
...
from scripts.private_speaker_review_next_final_review_host_contract import (  # noqa: E402
    REVIEW_NEXT_FINAL_REVIEW_HELPER_PATH,
    REVIEW_NEXT_FINAL_REVIEW_RECEIPTS_ROOT,
)
from scripts.private_speaker_review_next_final_review_host_contract import (
    SUDOERS_CONTENT as NEXT_FINAL_REVIEW_SUDOERS_CONTENT,
)
...
from scripts.private_speaker_review_third_adjudication_host_contract import (  # noqa: E402
    REVIEW_THIRD_ADJUDICATION_HELPER_PATH,
    REVIEW_THIRD_ADJUDICATION_RECEIPTS_ROOT,
)
from scripts.private_speaker_review_third_adjudication_host_contract import (  # noqa: E402
    SUDOERS_CONTENT as THIRD_ADJUDICATION_SUDOERS_CONTENT,
)
from scripts.private_speaker_review_third_adjudication_observation_host_contract import (  # noqa: E402
    REVIEW_THIRD_ADJUDICATION_OBSERVATION_HELPER_PATH,
    REVIEW_THIRD_ADJUDICATION_OBSERVATION_RECEIPTS_ROOT,
)
from scripts.private_speaker_review_third_adjudication_observation_host_contract import (  # noqa: E402
    SUDOERS_CONTENT as THIRD_ADJUDICATION_OBSERVATION_SUDOERS_CONTENT,
)
...
SOURCE_THIRD_ADJUDICATION_HELPER: Final = (
    REPOSITORY_ROOT / "deploy/remote/submit-third-private-speaker-review-adjudication.sh"
)
SOURCE_THIRD_ADJUDICATION_OBSERVATION_HELPER: Final = (
    REPOSITORY_ROOT / "deploy/remote/observe-third-private-speaker-review-adjudication.sh"
)
SOURCE_FOURTH_ADJUDICATION_HELPER: Final = (
    REPOSITORY_ROOT / "deploy/remote/submit-fourth-private-speaker-review-adjudication.sh"
)
SOURCE_FOURTH_ADJUDICATION_OBSERVATION_HELPER: Final = (
    REPOSITORY_ROOT / "deploy/remote/observe-fourth-private-speaker-review-adjudication.sh"
)
SOURCE_FINAL_REVIEW_HELPER: Final = (
    REPOSITORY_ROOT / "deploy/remote/submit-final-private-speaker-review.sh"
)
SOURCE_FINAL_REVIEW_OBSERVATION_HELPER: Final = (
    REPOSITORY_ROOT / "deploy/remote/observe-final-private-speaker-review.sh"
)
SOURCE_NEXT_FINAL_REVIEW_HELPER: Final = (
    REPOSITORY_ROOT / "deploy/remote/submit-next-final-private-speaker-review.sh"
)
...
DIRECTORY_CONTRACT: Final = (
    ...
    ExpectedPath(REVIEW_THIRD_ADJUDICATION_RECEIPTS_ROOT, "directory", 0, 0, 0o700),
    ExpectedPath(
        REVIEW_THIRD_ADJUDICATION_OBSERVATION_RECEIPTS_ROOT,
        "directory",
        0,
    ...
    ExpectedPath(REVIEW_FOURTH_ADJUDICATION_RECEIPTS_ROOT, "directory", 0, 0, 0o700),
    ExpectedPath(REVIEW_FOURTH_ADJUDICATION_OBSERVATION_RECEIPTS_ROOT, "directory", 0, 0, 0o700),
    ExpectedPath(REVIEW_FINAL_REVIEW_RECEIPTS_ROOT, "directory", 0, 0, 0o700),
    ExpectedPath(REVIEW_FINAL_REVIEW_OBSERVATION_RECEIPTS_ROOT, "directory", 0, 0, 0o700),
    ExpectedPath(REVIEW_NEXT_FINAL_REVIEW_RECEIPTS_ROOT, "directory", 0, 0, 0o700),
...
FILE_CONTRACT: Final = (
    ...
    ExpectedPath(REVIEW_THIRD_ADJUDICATION_HELPER_PATH, "file", 0, 0, 0o755),
    ExpectedPath(
        REVIEW_THIRD_ADJUDICATION_OBSERVATION_HELPER_PATH,
        "file",
        0,
    ...
    ExpectedPath(REVIEW_FOURTH_ADJUDICATION_HELPER_PATH, "file", 0, 0, 0o755),
    ExpectedPath(REVIEW_FOURTH_ADJUDICATION_OBSERVATION_HELPER_PATH, "file", 0, 0, 0o755),
    ExpectedPath(REVIEW_FINAL_REVIEW_HELPER_PATH, "file", 0, 0, 0o755),
    ExpectedPath(REVIEW_FINAL_REVIEW_OBSERVATION_HELPER_PATH, "file", 0, 0, 0o755),
    ExpectedPath(REVIEW_NEXT_FINAL_REVIEW_HELPER_PATH, "file", 0, 0, 0o755),
...
def _managed_content(public_key: str) -> dict[Path, bytes]:
    return {
        ...
        REVIEW_FOURTH_ADJUDICATION_HELPER_PATH: _read_source(SOURCE_FOURTH_ADJUDICATION_HELPER),
        REVIEW_FOURTH_ADJUDICATION_OBSERVATION_HELPER_PATH: _read_source(
            SOURCE_FOURTH_ADJUDICATION_OBSERVATION_HELPER
        ),
        REVIEW_FINAL_REVIEW_HELPER_PATH: _read_source(SOURCE_FINAL_REVIEW_HELPER),
        REVIEW_FINAL_REVIEW_OBSERVATION_HELPER_PATH: _read_source(
            SOURCE_FINAL_REVIEW_OBSERVATION_HELPER
        ),
        REVIEW_NEXT_FINAL_REVIEW_HELPER_PATH: _read_source(SOURCE_NEXT_FINAL_REVIEW_HELPER),
        REVIEW_SUDOERS_PATH: NEXT_FINAL_REVIEW_SUDOERS_CONTENT.encode("utf-8"),
...
def _preflight_refresh_host_files(
    ...
    for path, content in managed.items():
        ...
        if path == REVIEW_SUDOERS_PATH and installed[path] not in {
            ...
            THIRD_ADJUDICATION_SUDOERS_CONTENT.encode("utf-8"),
            THIRD_ADJUDICATION_OBSERVATION_SUDOERS_CONTENT.encode("utf-8"),
            FOURTH_ADJUDICATION_SUDOERS_CONTENT.encode("utf-8"),
            FOURTH_ADJUDICATION_OBSERVATION_SUDOERS_CONTENT.encode("utf-8"),
            FINAL_REVIEW_SUDOERS_CONTENT.encode("utf-8"),
            FINAL_REVIEW_OBSERVATION_SUDOERS_CONTENT.encode("utf-8"),
            NEXT_FINAL_REVIEW_SUDOERS_CONTENT.encode("utf-8"),
        }:
